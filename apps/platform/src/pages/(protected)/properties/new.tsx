...
export const Route = createFileRoute("/(protected)/properties/new")({
...
function RouteComponent() {
  ...
  function handleFinish() {
    feedback.success(
      "Property created",
      `${form.name || "New property"} has been added to your portfolio.`,
    );
  ...
  return (
    ...
    >
      <div>
        ...
        <h1 className="mt-2 text-display-md">Add Property</h1>
