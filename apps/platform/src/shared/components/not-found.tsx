...
export function NotFound() {
  return (
    <main className="flex h-full w-full flex-col items-center justify-center gap-3.5 bg-background font-sans text-foreground">
      <style>{`
        ...
        .not-found-bulb {
          ...
          animation: not-found-sway 12s 0.5s infinite ease-out;
        }
      `}</style>
      ...
      >
        ...
        <g transform="translate(170.14515,0.038164)">
          <g className="not-found-bulb text-foreground">
            <path
        ...
        <g>
          <g
            style={{ fill: "url(#notFoundStrips)", stroke: "none" }}
            transform="matrix(0.97168718,0,0,1.0291378,170.14515,0.038164)"
          >
            <path
              style={{
                fill: "url(#notFoundStrips)",
                stroke: "currentColor",
      ...
      <p className="my-3.5 text-[22px]">O-o-oh! Something broke.</p>
      <Link
        to="/"
        className="border px-3 py-3 text-lg no-underline transition-colors duration-500 ease-in-out hover:bg-foreground hover:text-background"
      >
        Go Back
      </Link>
    </main>
